...
//    frame.size.height = _testView.contentSize.height;
//    _testView.frame = frame;
//
    CGRect frame = _testView.frame;
    UIEdgeInsets inset = _testView.contentInset;
    frame.size.height = _testView.contentSize.height + inset.top + inset.bottom;
    _testView.frame = frame;
